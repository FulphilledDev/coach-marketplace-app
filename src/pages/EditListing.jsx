...
function EditListing() {
    ...
    const storeImage = async (image) => {
      return new Promise((resolve, reject) => {
        ...
        uploadTask.on(
          ...
          () => {
            // Handle SUCCESSFUL uploads on complete (resolve)
    ...
    // Call storageImage function for ALL IMAGES UPLOADED
    ...
    // Now save update to db
    const docRef = doc(db, 'listings', params.listingId)
    await updateDoc(docRef, formDataCopy)
    setLoading(false)
    toast.success('Listing updated')
    // This is NOT FUCKING ROUTING to the correct page... result: '/create-listing?'
    // Attempt 1: Changed line 177 "formData.location" to "formDataCopy.location" (Same as for CreateListing Page)
